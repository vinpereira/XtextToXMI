...
public class TraceSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        FormalResult formalResult = (FormalResult)theEObject;
        T result = caseFormalResult(formalResult);
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Formal Result</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Formal Result</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseFormalResult(FormalResult object)
  {
    return null;
  }
